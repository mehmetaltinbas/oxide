...
int main(int argc, char** argv) {
    ...
    std::printf("{\"seed\":%u,\"water\":%d,\"grass\":%d,\"forest\":%d,\"beach\":%d,\"snow_beach\":%d,\"desert\":%d,\"snow\":%d,\"road\":%d,\"fresh\":%d,\"tree\":%d,\"stone\":%d,\"metal\":%d,\"sulfur\":%d,\"nettle\":%d,\"barrel\":%d}\n",
                seed, counts[0], counts[1], counts[2], counts[3], counts[4], counts[5], counts[6], counts[7], fresh, nodes[0], nodes[1], nodes[2], nodes[3], nodes[4], nodes[5]);
    return 0;
}
